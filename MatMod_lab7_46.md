...
subtitle: "Модель распространения рекламы - вариант 46"
...
![График решения уравнения модели Мальтуса](img/01.png)

В обратном случае $\alpha _1(t) << \alpha _2(t)$ получаем уравнение логистической кривой

![График логистической кривой](img/02.png)
...
3.	$\frac{dn}{dt} = (0.5\cos {12t} + n(t)0.3\cos{13t})(N-n(t))$
